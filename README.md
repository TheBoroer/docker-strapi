...
[![Docker Pulls](https://img.shields.io/docker/pulls/strapi/strapi.svg?style=for-the-badge)](https://hub.docker.com/r/boro/strapi)

### strapi@beta (3.0.0-beta.9)
...
1. `git clone https://github.com/TheBoroer/docker-strapi && cd strapi-docker`
2. Run using `docker-compose up`

## Pull from Docker Hub

```bash
docker pull boro/strapi
```
...
- `DATABASE_AUTHENTICATION_DATABASE` set the authentication.
